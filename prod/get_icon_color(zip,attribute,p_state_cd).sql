-- DROP FUNCTION public.get_icon_color(varchar, text, varchar);

CREATE OR REPLACE FUNCTION public.get_icon_color(p_zipcode character varying, attribute_filter text, p_state_cd character varying)
