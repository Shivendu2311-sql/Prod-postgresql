CREATE OR REPLACE FUNCTION public.get_agent_and_team_counts(
    p_agent_id text, 
    start_date date, 
    end_date date, 
...
BEGIN
    ...
    DispositionCounts AS (
        ...
        WHERE 
           ST_Contains(tg.geom, ST_SetSRID(ST_MakePoint(p.uv_variable_5::NUMERIC, p.uv_variable_4::NUMERIC), 4326))
          AND (
        CASE 
            WHEN (
